...
public interface BoardRepository extends JpaRepository<Board, Long> {
    ...
    @Query(nativeQuery = true,
            ...
            value = "select " +
                    ...
                    " FROM {h-schema}git_board b" +
                    " JOIN {h-schema}git_embedding be ON b.id = be.board_id" +
    ...
    @Query(nativeQuery = true,
            ...
            value = "select " +
                    ...
                    " 1 - (be.title_content <=> :embedding ::vector) as similarity" +
                    " FROM {h-schema}git_board b" +
                    " JOIN {h-schema}git_embedding be ON b.id = be.board_id AND b.recommended is true" +
